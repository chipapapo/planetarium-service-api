...
class ShowSessionSerializer(serializers.ModelSerializer):
    class Meta:
        model = ShowSession
        fields = ("id", "datetime", "astronomy_show", "planetarium_dome")
...
class ShowSessionDetailSerializer(ShowSessionSerializer):
    show = AstronomyShowListSerializer(many=False, read_only=True)
    ...
    class Meta:
        model = ShowSession
        fields = ("id", "datetime", "show", "planetarium_dome", "taken_places")
